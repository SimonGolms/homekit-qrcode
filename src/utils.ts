export const createLabelAsSvg = (pairingCode: string, qrCode: string) => {
...
<svg viewBox="0 0 400 540" xmlns="http://www.w3.org/2000/svg">
  ...
  <defs>
    ...
    <svg id="qrCode" ${qrCode.slice(5, -7)}</svg>
  </defs>
...
export const getFilename = (output: string) => {
